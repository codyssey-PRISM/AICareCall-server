...
BUNDLE_ID = "com.stevenkim.CallClient"       # 앱 Bundle ID = apns-topic
VOIP_TOPIC = BUNDLE_ID + ".voip"
VOIP_DEVICE_TOKEN = "693e9a147dfb8ebbb5ed31eff419313d4af80607f63255dd673c61b33be1c1d7"
DEVICE_TOKEN = "486858be7798863889c2f4980cb4bbd27301e3916b0c8ce15839eea087f125d4"    # iOS 디바이스에서 로그로 뽑은 토큰
P8_PRIVATE_KEY_PATH = "AuthKey_5XFZZ6ZD2H.p8"  # 다운로드한 p8 파일 경로

# 개발용 샌드박스 서버: api.sandbox.push.apple.com
# 배포용은 api.push.apple.com
...
async def send_push(req: PushRequest):
    ...
    headers = {
        ...
        "apns-topic": BUNDLE_ID,        # 필수
        # "apns-push-type": "alert",   # iOS 13+ 권장, 없으면 httpx가 자동 붙이기도 하지만 명시해도 좋음
    }
